...
#     dq2 = -8 * pi^3 * alpha * sqrt(g * (D + eta0)) * (D + eta0)^2 * exp(3 * t / 2) * a2 *
#           a4 +
#           8 * pi^3 * alpha * sqrt(g * (D + eta0)) * (D + eta0)^2 * exp(3 * t / 2) * a1 *
#           a3 - 2 * pi^2 * beta * (D + eta0)^3 * (a2 + 2 * pi * a1) * exp(t / 2) +
#           2 * pi * g * (D + exp(t) * a3) * exp(t) * a4 +
#           8.0 * pi^3 * gamma * sqrt(g * (D + eta0)) * (D + eta0)^3 * exp(t / 2) * a1 -
#           (D + exp(t) * a3) * (a2 + 2 * pi * a1) * exp(t / 2) / 2 -
#           4 * pi * (D + exp(t) * a3) * exp(t) * a2 * a1 +
#           (4 * pi * a4 - a3) * exp(3 * t / 2) * a2 + 2 * pi * exp(2 * t) * a2^2 * a4
#     v = q[2, :]
#     dq2 -= dq1 * exp(t / 2) * sinpi(2 * (x - t / 2))
#     dq2 = 8*pi^3*alpha*sqrt(g*(D + eta0))*(D + eta0)^2*exp(3*t/2)*a1*a3 - 2*pi^2*beta*(D + eta0)^3*(a2 + 2*pi*a1)*exp(t/2) + 2*pi*g*(D + exp(t)*a3)*exp(t)*a4 + 8.0*pi^3*gamma*sqrt(g*(D + eta0))*(D + eta0)^3*exp(t/2)*a1 - (D + exp(t)*a3)*(a2 + 2*pi*a1)*exp(t/2)/2 - 4*pi*(D + exp(t)*a3)*exp(t)*a2*a1 + 2*pi*((D + exp(t)*a3)*a1 - exp(t)*a2*a4)*exp(t)*a2 + 2*pi*exp(2*t)*a2^2*a4
    ...
    # When written in primitive variables:
#     dq2 = (20*pi*alpha*sqrt(g*(eta0*exp((x - 0.5)^2) + 4))*(2*x - 1.0)*((10*x - 5.0)*a4 + 2*pi*(eta0*exp((x - 0.5)^2) + 4)*a3)*exp(3*t/2 + 105*(x - 0.5)^2/4)*a2 + 8*pi^2*alpha*sqrt(g*(eta0*exp((x - 0.5)^2) + 4))*(eta0*exp((x - 0.5)^2) + 4)*((10*x - 5.0)*a4 + 2*pi*(eta0*exp((x - 0.5)^2) + 4)*a3)*exp(3*t/2 + 105*(x - 0.5)^2/4)*a1 + 4*pi*alpha*sqrt(g*(eta0*exp((x - 0.5)^2) + 4))*(-5*(2*x - 1.0)*((10*x - 5.0)*a4 + 2*pi*(eta0*exp((x - 0.5)^2) + 4)*a3)*exp(t + 25*(x - 0.5)^2/4) + 2*(-10*(x - 0.5)^2*a4 + 2*pi^2*(eta0*exp((x - 0.5)^2) + 4)^2*a4 + 5*(eta0*exp((x - 0.5)^2) + 4)*(-2*(x - 0.5)^2*a4 - 2*pi*(2*x - 1.0)*a3 + a4))*exp(t + 25*(x - 0.5)^2/4))*exp(t/2 + 20*(x - 0.5)^2)*a2 + 8*pi*alpha*sqrt(g*(eta0*exp((x - 0.5)^2) + 4))*(10*(x - 0.5)^2*a4 - 2*pi^2*(eta0*exp((x - 0.5)^2) + 4)^2*a4 + 5*(eta0*exp((x - 0.5)^2) + 4)*(2*(x - 0.5)^2*a4 + 2*pi*(2*x - 1.0)*a3 - a4))*exp(3*t/2 + 105*(x - 0.5)^2/4)*a2 - 4*pi*beta*(eta0*exp((x - 0.5)^2) + 4)^2*((6.0 - 12*x)*a1 + 12*pi*(2*x - 1.0)*a2 + pi*(eta0*exp((x - 0.5)^2) + 4)*a2 + 2*pi^2*(eta0*exp((x - 0.5)^2) + 4)*a1)*exp(t/2 + 103*(x - 0.5)^2/4) + pi*gamma*sqrt(g*(eta0*exp((x - 0.5)^2) + 4))*(eta0*exp((x - 0.5)^2) + 4)*(-384.0*(x - 0.5)^2*a1 + 168.0*pi*(2*x - 1.0)*(eta0*exp((x - 0.5)^2) + 4)*a2 + 16.0*pi^2*(eta0*exp((x - 0.5)^2) + 4)^2*a1 + (8.0*(1 - 2*(x - 0.5)^2)*(eta0*exp((x - 0.5)^2) + 4) + 32.0*(x - 0.5)^2)*a1 + (48.0*eta0*exp((x - 0.5)^2) - 96.0*(x - 0.5)^2*(eta0*exp((x - 0.5)^2) + 4) - 768.0*(x - 0.5)^2 + 192.0)*a1)*exp(t/2 + 101*(x - 0.5)^2/4) + (4*pi*g*(exp(t + (x - 0.5)^2)*a3 + 4)*exp(t)*a4 - (exp(t + (x - 0.5)^2)*a3 + 4)*(a2 + 2*pi*a1)*exp(t/2) - 8*pi*(exp(t + (x - 0.5)^2)*a3 + 4)*exp(t)*a2*a1 + 2*(2*pi*(exp(t + (x - 0.5)^2)*a3 + 4)*a1 + (8*x - 2*pi*exp(t + (x - 0.5)^2)*a4 - 4.0)*a2)*exp(t)*a2 + (-16*x + 4*pi*exp(t + (x - 0.5)^2)*a4 + 8.0)*exp(t)*a2^2)*exp(111*(x - 0.5)^2/4))*exp(-115*(x - 0.5)^2/4)/2
#     dq2 += dq1 * exp(t / 2) * sinpi(2 * (x - t / 2))
