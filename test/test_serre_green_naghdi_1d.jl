...
@testset "SerreGreenNaghdiEquations1D" begin
    @trixi_testset "serre_green_naghdi_soliton.jl" begin
        @test_trixi_include(joinpath(EXAMPLES_DIR,
                            ...
                            tspan=(0.0, 0.1),
                            l2=[9.994998669268741e-7, 1.4703955789342244e-6, 0.0],
                            linf=[6.5496216650196e-7, 1.027615853854691e-6, 0.0],
    ...
    @trixi_testset "serre_green_naghdi_soliton_fourier.jl" begin
        @test_trixi_include(joinpath(EXAMPLES_DIR,
                            ...
                            linf=[2.6719845003242426e-8, 9.642725156897014e-8, 0.0],
    ...
    @trixi_testset "serre_green_naghdi_soliton_upwind.jl" begin
        @test_trixi_include(joinpath(EXAMPLES_DIR,
                            ...
                            tspan=(0.0, 0.1),
                            l2=[1.4876412924488654e-6, 5.988810995995645e-6, 0.0],
                            linf=[1.0863034516361836e-6, 4.105929242048667e-6, 0.0],
    ...
    @trixi_testset "serre_green_naghdi_soliton_relaxation.jl" begin
        @test_trixi_include(joinpath(EXAMPLES_DIR,
                            ...
                            linf=[2.6722121404532118e-8, 9.64274304918189e-8, 0.0],
